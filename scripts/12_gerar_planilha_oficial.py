...
DICIONARIO = {
    ...
    "DS_MODELO_DADOS": "Modelo/estrutura de arquivo usada no ano.",
    ...
    "DS_NIVEL_COMPARABILIDADE": "Nível metodológico de comparabilidade do recorte no ano.",
    "DS_OBSERVACAO_COMPARABILIDADE": "Observação curta sobre limitações ou aproximações do ano.",
